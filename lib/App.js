      ...
      if (this.state.currentWeather) {
        return (
          <div>
            ...
            <Current 
              currentCity=
                { clean(this.state.currentWeather).current.currentCity }
              currentCondition=
                { clean(this.state.currentWeather).current.currentCondition }
              currentDay=
                { clean(this.state.currentWeather).current.currentDay }
              currentTemp=
                { clean(this.state.currentWeather).current.currentTemp }
              currentDayHigh=
                { clean(this.state.currentWeather).current.currentDayHigh }
              currentDayLow=
                { clean(this.state.currentWeather).current.currentDayLow }
              currentDaySummary=
                { clean(this.state.currentWeather).current.currentDaySummary }
              currentWeatherImg=
                { clean(this.state.currentWeather).current.currentWeatherImg }
            />
